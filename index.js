...
console.log(color(figlet.textSync('THAKKUDU 3.7 MD ', {
		font: 'Pagga',
...
console.log(color('\n🎈 YT CHANNEL: PBA MODS ','silver'))
console.log(color('🎈 GITHUB: I4MBetAZ ','silver'))
console.log(color('🎈 WA NUMBER: +919037042728 ','silver'))
console.log(color('  PBA MODS THAKKUDU 3.7','mediumseagreen'))
    console.log(color('🎈','red'), color('How Are YOu!', 'yellow'))
    console.log(color('🎈','red'), color('Source Code Version: 3.7', 'aqua'))
    console.log(color('🎈','red'), color('Error? Suggestion? Talk to developer:', 'aqua'))
    console.log(color('🎈', 'cyan'), color('https://wa.me/919037042728'))
    console.log(color('🎈', 'cyan'), color('Thakkudu Is Alive...', 'pink'))
    console.log(color('🎈', 'cyan'), color('Welcome Back Owner! Hope You Doing Well~', 'magenta'))
    console.log(color('🎈','red'), color('Thanks For Using Thakkudu', 'white'))
    let { version, isLatest } = await fetchLatestBaileysVersion()
    const XeonBotInc = XeonBotIncConnect({
        logger: pino({ level: 'silent' }),
        printQRInTerminal: true,
        browser: ['Subscribe PBA MoDs','Safari','1.0.0'],
        auth: state,
        version
    })
...
require("./Thakkuduhiddens")(XeonBotInc, m, chatUpdate, store)
} catch (err) {
console.log(err)
}
})
...
XeonBotInc.ev.on('groups.update', async pea => {
    ...
    // Get Profile Picture Group
       ...
       ppgc = 'https://telegra.ph/file/c67ceeca69ec0c3164ffe.jpg'
       }
...
└┬❖ 「 @${xeonName.split("@")[0]}  」
   ...
   //you fail to put, i sue you for sure!
let buttons = [
{buttonId: `wkwkwk`, buttonText: {displayText: 'Bye the Bye👋 '}, type: 1}
]
let buttonMessage = {
document: fs.readFileSync('./Thakkuduitems/theme/cheems.xlsx'),
mimetype: docs,
